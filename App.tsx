...
const VerifyPapers = lazy(() => import('./pages/dashboard/admin/VerifyPapers'));
...
const MySubmissions = lazy(() => import('./pages/dashboard/student/MySubmissions'));
          ...
          <HashRouter>
            <Routes>
              ...
              >
                ...
                <Route path="papers" element={<VerifyPapers />} />
              ...
              >
                ...
                <Route path="papers" element={<MySubmissions />} />
