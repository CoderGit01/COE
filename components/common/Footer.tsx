    ...
    <footer className="bg-orange-accent text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-semibold text-orange-200 tracking-wider uppercase">Community</h3>
            <ul className="mt-4 space-y-4">
                <li><NavLink to="/community" className="text-base text-white hover:text-orange-100">Community Feed</NavLink></li>
