        ...
        <div className="bg-gray-50 min-h-screen pt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-extrabold text-gray-900">Community Hub</h1>
                    <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-500">
                        Connect, share, and celebrate achievements with students and faculty from the Center of Excellence.
                    </p>
                </div>
                ...
                <div className="mt-24">
                    <div className="text-center">
                        ...
                        <h2 className="mt-4 text-3xl font-extrabold text-gray-900">Community Achievements</h2>
                        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-500">
                            Celebrating the remarkable achievements of our community members.
                        </p>
                    </div>
